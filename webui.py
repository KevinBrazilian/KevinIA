    ...
    while not finished:
        ...
        if len(task.yields) > 0:
            ...
            if flag == 'finish':
                ...
                # delete KevinIA temp images, only keep gradio temp images
...
title = f'KevinIA {kevinia_version.version}'
    ...
    with gr.Row():
            ...
            with gr.Row(visible=modules.config.default_image_prompt_checkbox) as image_input_panel:
                with gr.Tabs(selected=modules.config.default_selected_image_input_tab_id):
                    with gr.Tab(label='Upscale or Variation', id='uov_tab') as uov_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/lllyasviel/KevinIA/discussions/390" target="_blank">\U0001F4D4 Documentation</a>')
                    with gr.Tab(label='Image Prompt', id='ip_tab') as ip_tab:
                        ...
                        gr.HTML('* \"Image Prompt\" is powered by KevinIA Image Mixture Engine (v1.0.1). <a href="https://github.com/lllyasviel/KevinIA/discussions/557" target="_blank">\U0001F4D4 Documentation</a>')
                        ...
                        with gr.Row():
                            with gr.Column():
                                ...
                                example_inpaint_prompts = gr.Dataset(samples=modules.config.example_inpaint_prompts,
                                                                     ...
                                                                     visible=False)
                                gr.HTML('* Powered by KevinIA Inpaint Engine <a href="https://github.com/lllyasviel/KevinIA/discussions/414" target="_blank">\U0001F4D4 Documentation</a>')
                    ...
                    with gr.Tab(label='Describe', id='describe_tab') as describe_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/lllyasviel/KevinIA/discussions/1363" target="_blank">\U0001F4D4 Documentation</a>')
                    ...
                    with gr.Tab(label='Enhance', id='enhance_tab') as enhance_tab:
                        with gr.Row():
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://github.com/lllyasviel/KevinIA/discussions/3281" target="_blank">\U0001F4D4 Documentation</a>')

                    with gr.Tab(label='Metadata', id='metadata_tab') as metadata_tab:
                        with gr.Column():
                            metadata_input_image = grh.Image(label='For images created by KevinIA', source='upload', type='pil')
                        ...
                        with gr.Tab(label=f'#{index + 1}') as enhance_tab_item:
                            ...
                            with gr.Accordion("Inpaint", visible=True, open=False):
                                ...
                                enhance_inpaint_engine = gr.Dropdown(label='Inpaint Engine',
                                                                     ...
                                                                     info='Version of KevinIA inpaint model. If set, use performance Quality or Speed (no performance LoRAs) for best results.')
        ...
        with gr.Column(scale=1, visible=modules.config.default_advanced_checkbox) as advanced_column:
            ...
            with gr.Tab(label='Advanced'):
                ...
                gr.HTML('<a href="https://github.com/lllyasviel/KevinIA/discussions/117" target="_blank">\U0001F4D4 Documentation</a>')
                ...
                with gr.Column(visible=modules.config.default_developer_debug_mode_checkbox) as dev_tools:
                    with gr.Tab(label='Debug Tools'):
                        ...
                        adaptive_cfg = gr.Slider(label='CFG Mimicking from TSNR', minimum=1.0, maximum=30.0, step=0.01,
                                                 ...
                                                 info='Enabling KevinIA\'s implementation of CFG mimicking for TSNR '
