...
def prepare_environment():
    ...
    print(f"KevinIA version: {kevinia_version.version}")
...
def download_models(default_model, previous_default_models, checkpoint_downloads, embeddings_downloads, lora_downloads, vae_downloads):
    ...
    load_file_from_url(
        url='https://huggingface.co/lllyasviel/misc/resolve/main/kevinia_expansion.bin',
        model_dir=config.path_kevinia_expansion,
        ...
        if not os.path.isfile(get_file_from_folder_list(default_model, config.paths_checkpoints)):
            for alternative_model_name in previous_default_models:
                if os.path.isfile(get_file_from_folder_list(alternative_model_name, config.paths_checkpoints)):
                    ...
                    print(f'KevinIA will use [{alternative_model_name}] to avoid downloading new models, '
