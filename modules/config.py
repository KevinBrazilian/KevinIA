...
def try_load_deprecated_user_path_config():
    ...
    try:
        ...
        replace_config('fooocus_expansion_path', 'path_kevinia_expansion')
...
path_kevinia_expansion = get_dir_or_set_default('path_kevinia_expansion', '../models/prompt_expansion/fooocus_expansion')
